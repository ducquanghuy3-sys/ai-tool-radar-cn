window.AUTO_POSTS = [
  ...
  {
    "id": "auto-github-blog-enterprise-managed-settings-now-support-strictknownmarketplaces-in-vs-code-and",
    "title": "GitHub Copilot CLI 新内容：适合命令行用户关注",
    "originalTitle": "Enterprise-managed settings now support strictKnownMarketplaces in VS Code and GitHub Copilot CLI",
    ...
    "commentsSample": [
      [
        "自动中文编辑",
        "原题：Enterprise-managed settings now support strictKnownMarketplaces in VS Code and GitHub Copilot CLI。来源：GitHub Blog。已自动改写为中文标题和中文判断。"
      ]
    ]
  },
  {
  ...
  {
    "id": "auto-anthropic-com-product-jun-23-2026-introducing-claude-tag-claude-tag-is-a-new-way-for-teams",
    "title": "anthropic.com 发布 Claude 相关更新，重点看真实工作流影响",
    "originalTitle": "Product Jun 23, 2026 Introducing Claude Tag Claude Tag is a new way for teams to work with Claude.",
    ...
    "commentsSample": [
      [
        "自动中文编辑",
        "原题：Product Jun 23, 2026 Introducing Claude Tag Claude Tag is a new way for teams to work with Claude.。来源：Anthropic News。已自动改写为中文标题和中文判断。"
      ]
    ]
  },
  {
    "id": "auto-anthropic-com-tcs-and-anthropic-partner-to-bring-claude-to-regulated-industries",
    "title": "anthropic.com 发布 Claude 相关更新，重点看真实工作流影响",
    "originalTitle": "TCS and Anthropic partner to bring Claude to regulated industries",
    ...
    "commentsSample": [
      [
        "自动中文编辑",
        "原题：TCS and Anthropic partner to bring Claude to regulated industries。来源：Anthropic News。已自动改写为中文标题和中文判断。"
      ]
    ]
  },
  {
  ...
  {
    "id": "auto-anthropic-com-claude-fable-5-and-claude-mythos-5",
    "title": "anthropic.com 发布 Claude 相关更新，重点看真实工作流影响",
    "originalTitle": "Claude Fable 5 and Claude Mythos 5",
    ...
    "commentsSample": [
      [
        "自动中文编辑",
        "原题：Claude Fable 5 and Claude Mythos 5。来源：Anthropic News。已自动改写为中文标题和中文判断。"
      ]
    ]
  },
  {
