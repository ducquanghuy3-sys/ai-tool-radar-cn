window.AUTO_POSTS = [
  ...
  {
    "id": "auto-github-blog-the-harness-is-all-you-need-mostly-",
    "title": "github.blog 发布 AI 工具更新，适合判断是否纳入日常流程",
    "originalTitle": "The harness is all you need (mostly)",
    ...
    "commentsSample": [
      [
        "自动中文编辑",
        "原题：The harness is all you need (mostly)。来源：GitHub Blog。已自动改写为中文标题和中文判断。"
      ]
    ]
  },
  {
    "id": "auto-github-blog-github-copilot-app-for-beginners-getting-started",
    "title": "github.blog 发布 AI 工具更新，适合判断是否纳入日常流程",
    "originalTitle": "GitHub Copilot app for Beginners: Getting started",
