window.AUTO_POSTS = [
  ...
  {
    "id": "auto-github-blog-fix-with-copilot-for-failing-actions-now-in-pro-pro-and-max",
    "title": "github.blog 发布 AI 工具更新，适合判断是否纳入日常流程",
    "originalTitle": "Fix with Copilot for failing Actions now in Pro, Pro+, and Max",
    ...
    "commentsSample": [
      [
        "自动中文编辑",
        "原题：Fix with Copilot for failing Actions now in Pro, Pro+, and Max。来源：GitHub Blog。已自动改写为中文标题和中文判断。"
      ]
    ]
  },
  {
    "id": "auto-github-blog-agent-tasks-rest-api-now-available-for-copilot-pro-pro-and-max",
    "title": "GitHub Copilot Agent 更新：云端执行速度和工作流继续优化",
    "originalTitle": "Agent tasks REST API now available for Copilot Pro, Pro+, and Max",
    ...
    "commentsSample": [
      [
        "自动中文编辑",
        "原题：Agent tasks REST API now available for Copilot Pro, Pro+, and Max。来源：GitHub Blog。已自动改写为中文标题和中文判断。"
      ]
    ]
  },
  {
